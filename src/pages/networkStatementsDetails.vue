...
export default {
  ...
  methods: {
    print(){
window.open(`${JSON.parse(window.sessionStorage.getItem("url")).baseURL}/api/export/network/detail?type=${this.$route.query.type}&startTime=${this.$route.query.startTime}&accessToken=${JSON.parse(window.sessionStorage.getItem("operationToken"))}`,"blank")
    },
    changeTimeScale(e){
