...
export default {
  ...
  methods: {
    ...
    seeDetails(item){
        ...
        this.$nextTick(()=>{
          this.$router.push({ path: "/lowVoltageRoomStatementsDetails", query: { title: printTitle,id:item.id,startTime:item.startTime.substring(0,10),type:item.type,menuIconId:6}});
        })
    ...
    Title (){
      ...
      switch(this.timeScale){
        ...
        return '弱电间周次巡检表';
        case 3:
        return '弱电间'+ month+'月次巡检表';
        case 4:
        return '弱电间'+ year+'年次巡检表';
      }
    }
  },
  computed:{
